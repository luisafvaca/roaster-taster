<template>
  <div class="flex flex-col lg:flex-row gap-8">
      ...
      <div class="card shadow-xl mx-auto max-w-4xl">
        <div class="card-body">
          <div class="card-header mb-6">
            ...
            <h1 class="text-xl font-semibold text-primary-600 text-center mt-2">
              {{ $t('app.title') }}
            </h1>
          </div>
    ...
    <div class="mt-8 p-8 space-y-8">
      ...
      <div class="card shadow-xl mx-auto max-w-4xl">
        <div class="card-body">
          <h3 class="text-2xl font-bold text-primary-800 mb-4 text-center">Perfil de Sabor</h3>
      ...
      <div class="card shadow-xl mx-auto max-w-4xl">
        <div class="card-body">
          <h3 class="text-2xl font-bold text-primary-800 mb-4 text-center">Penalizaciones</h3>
